  ...
  const processedData = useMemo(() => {
    ...
    const finalEmployees = employees.map(emp => {
      const rowData = {
        ...
        totalTdkAbsen: 0 // Menyimpan jumlah tidak absen (status '0')
      };
                ...
                <table className="w-full text-sm text-left whitespace-nowrap border-collapse">
                  <thead className="text-[11px] text-slate-650 dark:text-zinc-400 uppercase bg-slate-50 dark:bg-zinc-850 sticky top-0 z-20 shadow-xs border-b border-slate-200/80 dark:border-zinc-800">
                    <tr>
                      ...
                      <th className="px-3 py-3.5 text-center bg-indigo-50 dark:bg-zinc-850 text-indigo-900 dark:text-indigo-450 sticky right-[325px] z-30 font-bold border-l border-indigo-200 dark:border-zinc-850 w-[70px] min-w-[70px] max-w-[70px]">
                        Total HK
                      </th>
                      <th className="px-3 py-3.5 text-center bg-purple-50 dark:bg-zinc-850 text-purple-900 dark:text-purple-400 sticky right-[275px] z-30 font-bold border-l border-purple-200/40 dark:border-zinc-850 w-[50px] min-w-[50px] max-w-[50px]">
                        Izin
                      </th>
                      <th className="px-3 py-3.5 text-center bg-sky-50 dark:bg-zinc-850 text-sky-900 dark:text-sky-400 sticky right-[225px] z-30 font-bold border-l border-sky-200/40 dark:border-zinc-850 w-[50px] min-w-[50px] max-w-[50px]">
                        Sakit
                      </th>
                      <th className="px-3 py-3.5 text-center bg-teal-50 dark:bg-zinc-850 text-teal-900 dark:text-teal-450 sticky right-[175px] z-30 font-bold border-l border-teal-200/40 dark:border-zinc-850 w-[50px] min-w-[50px] max-w-[50px]">
                        Cuti
                      </th>
                      <th className="px-3 py-3.5 text-center bg-amber-50 dark:bg-zinc-850 text-amber-900 dark:text-amber-400 sticky right-[125px] z-30 font-bold border-l border-amber-200/40 dark:border-zinc-850 w-[50px] min-w-[50px] max-w-[50px]">
                        NO CO
                      </th>
                      <th className="px-3 py-3.5 text-center bg-rose-50 dark:bg-zinc-850 text-rose-900 dark:text-rose-455 sticky right-[75px] z-30 font-bold border-l border-rose-200/40 dark:border-zinc-850 w-[75px] min-w-[75px] max-w-[75px]">
                        Terlambat
                      </th>
                      <th className="px-3 py-3.5 text-center bg-slate-100 dark:bg-zinc-850 text-slate-700 dark:text-zinc-300 sticky right-0 z-30 font-bold border-l border-slate-200 dark:border-zinc-800 w-[50px] min-w-[50px] max-w-[50px]">
                        TDK ABSEN
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-150 dark:divide-zinc-800">
                    {processedData.employees.map((emp, idx) => (
                      <tr key={idx} className="hover:bg-slate-50/50 dark:hover:bg-zinc-850/40 group transition-all duration-150">
                        ...
                        <td className="px-3 py-2 text-center bg-indigo-50 dark:bg-indigo-950 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900 font-extrabold text-indigo-800 dark:text-indigo-400 sticky right-[325px] z-10 border-l border-indigo-100 dark:border-indigo-900 text-xs w-[70px] min-w-[70px] max-w-[70px] transition-colors duration-150">
                          {emp.totalHk}
                        </td>
                        <td className="px-3 py-2 text-center bg-purple-50 dark:bg-purple-950 group-hover:bg-purple-100 dark:group-hover:bg-purple-900 text-purple-700 dark:text-purple-400 font-bold sticky right-[275px] z-10 border-l border-purple-100 dark:border-purple-900 text-xs w-[50px] min-w-[50px] max-w-[50px] transition-colors duration-150">
                          {emp.totalI}
                        </td>
                        <td className="px-3 py-2 text-center bg-sky-50 dark:bg-sky-950 group-hover:bg-sky-100 dark:group-hover:bg-sky-900 text-sky-700 dark:text-sky-400 font-bold sticky right-[225px] z-10 border-l border-sky-100 dark:border-sky-900 text-xs w-[50px] min-w-[50px] max-w-[50px] transition-colors duration-150">
                          {emp.totalS}
                        </td>
                        <td className="px-3 py-2 text-center bg-teal-50 dark:bg-teal-950 group-hover:bg-teal-100 dark:group-hover:bg-teal-900 text-teal-700 dark:text-teal-455 font-bold sticky right-[175px] z-10 border-l border-teal-100 dark:border-teal-900 text-xs w-[50px] min-w-[50px] max-w-[50px] transition-colors duration-150">
                          {emp.totalC}
                        </td>
                        <td className="px-3 py-2 text-center bg-amber-50 dark:bg-amber-950 group-hover:bg-amber-100 dark:group-hover:bg-amber-900 text-amber-700 dark:text-amber-400 font-bold sticky right-[125px] z-10 border-l border-amber-100 dark:border-amber-900 text-xs w-[50px] min-w-[50px] max-w-[50px] transition-colors duration-150">
                          {emp.totalNoCo}
                        </td>
                        <td className="px-3 py-2 text-center bg-rose-50 dark:bg-rose-955 group-hover:bg-rose-100 dark:group-hover:bg-rose-900 text-rose-800 dark:text-rose-400 font-extrabold sticky right-[75px] z-10 border-l border-rose-150 dark:border-rose-900 text-xs w-[75px] min-w-[75px] max-w-[75px] transition-colors duration-150">
                          {emp.totalTerlambat}
                        </td>
                        <td className="px-3 py-2 text-center bg-slate-50 dark:bg-zinc-900 group-hover:bg-slate-100 dark:group-hover:bg-zinc-800 text-slate-700 dark:text-zinc-300 font-bold sticky right-0 z-10 border-l border-slate-200 dark:border-zinc-700 text-xs w-[50px] min-w-[50px] max-w-[50px] transition-colors duration-150">
                          {emp.totalTdkAbsen}
                        </td>
                      </tr>
                    ))}
